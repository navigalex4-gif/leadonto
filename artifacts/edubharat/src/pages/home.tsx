    ...
    <>
      ...
      <div className="home-shell min-w-0 overflow-hidden">
        ...
        <div className="container mx-auto max-w-6xl px-5 sm:px-8">
          <MobilePrimaryCTA
            label="Check My Communication Free"
            href="/communication-check"
            onClick={() => {
              track("home_cta_clicked", { cta: "communication_check", placement: "mobile_sticky" });
              trackFunnel("cta_clicked", { cta: "communication_check", placement: "mobile_sticky" });
            }}
          />
        </div>
